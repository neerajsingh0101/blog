...
{% highlight java %} List results= session.createFilter(company.getEmployees(), "where this.salary > 100").list(); {% endhighlight %}
...
{% highlight java %} List results= session.createFilter(company.getEmployees(),"where this.fulltime='Y'").list();{% endhighlight %}
