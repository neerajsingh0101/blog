...
h2. When a var is used to declare a function then only the definition gets hoisted up
...
h2. When a function variable is declared without var then both definition and body gets hoisted up
