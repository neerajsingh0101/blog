...
{% highlight ruby %}ruby script/pluging install -f exception_notification{% endhighlight %}
...
{% highlight ruby %}ruby script/pluging install -o exception_notification{% endhighlight %}
